        ...
        <div className="flex justify-center gap-3 mb-12 flex-wrap">
          {['Standard', 'More Options', 'Panoramic'].map(tab => (
            <button
              ...
              className={`px-6 py-2.5 rounded-full font-mono text-[10px] uppercase tracking-wider font-bold transition-all duration-300 cursor-pointer ${activeCabinTab === tab
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
            {filteredCabins.map(cabin => (
              <div
                ...
                className={`border rounded-2xl p-4 bg-gray-50/50 hover:bg-white cursor-pointer transition-all duration-300 group flex flex-col items-center ${selectedCabinSlug === cabin.slug
