...
export default function NewHomeLiftPage() {
  ...
  const handleSubmit = async (payload) => {
    ...
    try {
      ...
      // Step 2: Create the product with lightweight URL references
      setStatusMsg('Creating home lift...')
