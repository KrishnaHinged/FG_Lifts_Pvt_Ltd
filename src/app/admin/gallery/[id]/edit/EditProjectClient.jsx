...
export default function EditProjectClient({ project, products = [] }) {
  ...
  const handleSubmit = async (payload) => {
    ...
    setErrorMsg('')
    try {
      const res = await fetch(`/api/admin/gallery/${project._id}`, {
        method: 'PUT',
      ...
      if (res.ok && data.success) {
        ...
        setErrorMsg(data.error || 'Failed to update showcase project.')
      }
    } catch {
